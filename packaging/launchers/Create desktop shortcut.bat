@echo off
REM  Puts a MPN shortcut on the Desktop, pointing back at this folder.
REM
...
title MPN - Create desktop shortcut
setlocal

set "TARGET=%~dp0MPN.bat"
set "ICON=%~dp0app\mpn\assets\mpn.ico"

if not exist "%TARGET%" (
  echo [X] "MPN.bat" is not next to this file.
